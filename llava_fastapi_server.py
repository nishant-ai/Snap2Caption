...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # 🔓 Allow all origins; replace with specific domains for more security
...
OUTPUT_LENGTH = Histogram("model_output_length_tokens", "Length of generated caption", buckets=[10, 20, 40, 80, 120, 160])
...
class CaptionRequest(BaseModel):
    ...
    prompt: str  # will be ignored in backend, kept for client compatibility
...
async def generate_caption(req: CaptionRequest):
    ...
    try:
        ...
        duration_ms = start.elapsed_time(end) / 1000.0  # convert to seconds
